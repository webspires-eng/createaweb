<?php include 'include/header.html'; ?>
    ...
    <div id="smooth-wrapper">
        <div id="smooth-content">
            ...
            <div class="breadcrumb-page-area-one style-2 fix">
                <div class="breadcrumb-page-wrap pb-75 pt-75">
                    <div class="container">
                        <div class="gt-breadcrumb-wrapper mb-0 pt-96 pb-96"
                            style="background: url(./assets/img/pages/projectPageBg1_2.png);">
                            <div class="title ml-60">Case Study</div>
                        </div>
                    </div>
                </div>
            </div>
