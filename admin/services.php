...
<div class="page-header animate-in">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-2" style="background: transparent; padding: 0;">
            ...
            <li class="breadcrumb-item"><a href="services.php" style="color: var(--gt-text-muted); text-decoration: none;">Services</a></li>
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-4">
                    <div class="col-12">
                        ...
                        <input type="text" name="title" class="form-control" value="<?php echo htmlspecialchars($service['title'] ?? ''); ?>" placeholder="e.g. Web Development" required>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="icon" class="form-control" value="<?php echo htmlspecialchars($service['icon'] ?? ''); ?>" placeholder="e.g. fa-code" style="border-radius: 0 12px 12px 0;">
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <?php if($service['image'] ?? ''): ?>
                            <div class="mt-3 d-flex align-items-center gap-3">
                                <img src="../<?php echo $service['image']; ?>" width="60" height="60" style="object-fit: cover; border-radius: 10px; border: 2px solid rgba(201, 243, 29, 0.2);">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="description" class="form-control" rows="6" placeholder="Write a detailed description of the service..."><?php echo htmlspecialchars($service['description'] ?? ''); ?></textarea>
                    </div>
                </div>
        ...
        <div class="card p-4 animate-in" style="animation-delay: 0.1s;">
            ...
            <div class="d-flex flex-column gap-3">
                <div class="d-flex gap-3" style="padding: 12px; background: rgba(201, 243, 29, 0.05); border-radius: 10px;">
                    ...
                    <small class="text-muted">Use a clear, descriptive title that explains what the service offers.</small>
                </div>
                ...
                <div class="d-flex gap-3" style="padding: 12px; background: rgba(236, 72, 153, 0.05); border-radius: 10px;">
                    ...
                    <small class="text-muted">Find icons at <a href="https://fontawesome.com/icons" target="_blank" style="color: var(--gt-theme);">fontawesome.com</a></small>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="table-responsive">
        <table class="table align-middle mb-0">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <img src="../<?php echo $s['image'] ?: 'assets/img/placeholder.jpg'; ?>" class="table-img" alt="<?php echo htmlspecialchars($s['title']); ?>">
                    </td>
                    <td>
                        <div class="d-flex align-items-center gap-2">
                            <?php if($s['icon']): ?>
                                <span style="width: 32px; height: 32px; background: rgba(201, 243, 29, 0.1); border-radius: 8px; display: flex; align-items: center; justify-content: center;">
                                    <i class="fas <?php echo htmlspecialchars($s['icon']); ?>" style="color: var(--gt-theme); font-size: 0.85rem;"></i>
                                </span>
                            <?php endif; ?>
                    ...
                    <td>
                        <span class="text-muted"><?php echo substr(htmlspecialchars($s['description']), 0, 80); ?>...</span>
                    </td>
                    <td>
                        <div class="d-flex gap-2">
                            <a href="services.php?action=edit&id=<?php echo $s['id']; ?>" class="action-btn edit" title="Edit">
                                <i class="fas fa-edit"></i>
                            </a>
                            <a href="services.php?action=delete&id=<?php echo $s['id']; ?>" class="action-btn delete" title="Delete" onclick="return confirm('Are you sure you want to delete this service?')">
