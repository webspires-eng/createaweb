    ...
    <div class="page-header animate-in">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-2" style="background: transparent; padding: 0;">
                ...
                <li class="breadcrumb-item"><a href="blogs.php"
                        style="color: var(--gt-text-muted); text-decoration: none;">Blogs</a></li>
                <li class="breadcrumb-item active" style="color: var(--gt-theme);"><?php echo $id ? 'Edit' : 'New Post'; ?>
                </li>
            </ol>
        </nav>
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            ...
                            <input type="text" name="title" class="form-control"
                                ...
                                placeholder="Enter an engaging blog title..." required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="author" class="form-control"
                                    value="<?php echo htmlspecialchars($blog['author'] ?? $_SESSION['admin_user']); ?>"
                        ...
                        <div class="col-md-6">
                            ...
                            <?php if ($blog['thumb'] ?? ''): ?>
                                <div class="mt-3 d-flex align-items-center gap-3">
                                    <img src="../<?php echo $blog['thumb']; ?>" width="80" height="50"
                                        style="object-fit: cover; border-radius: 8px; border: 2px solid rgba(201, 243, 29, 0.2);">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="content" class="form-control" rows="12"
                                placeholder="Write your blog content here... You can use HTML tags for formatting."><?php echo htmlspecialchars($blog['content'] ?? ''); ?></textarea>
            ...
            <div class="card p-4 animate-in" style="animation-delay: 0.1s;">
                ...
                <div class="d-flex flex-column gap-3">
                    <div class="d-flex gap-3"
                        style="padding: 12px; background: rgba(201, 243, 29, 0.05); border-radius: 10px;">
                    ...
                    <div class="d-flex gap-3"
                        style="padding: 12px; background: rgba(34, 197, 94, 0.05); border-radius: 10px;">
                ...
                <div class="col-lg-4 col-md-6 animate-in">
                    <div class="card h-100" style="overflow: hidden;">
                        <div style="position: relative; height: 200px; overflow: hidden;">
                            <img src="../<?php echo $b['thumb'] ?: 'assets/img/placeholder.jpg'; ?>"
                            ...
                            <div style="position: absolute; top: 15px; right: 15px; display: flex; gap: 8px;">
                                <a href="blogs.php?action=edit&id=<?php echo $b['id']; ?>" class="action-btn edit"
                                    style="width: 34px; height: 34px;" title="Edit">
                                    <i class="fas fa-edit" style="font-size: 0.85rem;"></i>
                                </a>
                                <a href="blogs.php?action=delete&id=<?php echo $b['id']; ?>" class="action-btn delete"
                                    style="width: 34px; height: 34px;" title="Delete"
                        ...
                        <div class="p-4">
                            <div class="d-flex align-items-center gap-2 mb-3">
                                <span
                                    style="padding: 4px 10px; background: rgba(201, 243, 29, 0.1); border-radius: 20px; font-size: 0.75rem; color: var(--gt-theme);">
                            ...
                            <h5
                                style="font-family: 'Inter', sans-serif; font-weight: 600; font-size: 1.1rem; text-transform: none; letter-spacing: 0; line-height: 1.4; margin-bottom: 10px;">
    ...
    <?php else: ?>
        <div class="card p-5 animate-in">
            <div class="text-center">
                <div
                    style="width: 80px; height: 80px; background: rgba(201, 243, 29, 0.1); border-radius: 20px; display: flex; align-items: center; justify-content: center; margin: 0 auto 20px;">
